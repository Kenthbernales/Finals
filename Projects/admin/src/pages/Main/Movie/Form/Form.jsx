  ...
  const handleSearch = useCallback(() => {
    ...
    axios.get(`https://api.themoviedb.org/3/search/movie?query=${query}&include_adult=false&language=en-US&page=${currentPage}`, {
      headers: {
        ...
        Authorization:  'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0ZmU2ZDFjMzEyNmRlMmU5YTdmODNhMTk2ZGU0M2I2ZSIsIm5iZiI6MTczMzMyMDI5MS43OTUsInN1YiI6IjY3NTA1ZTYzNjU2NzAyYTc5MmZmYmEyNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.65lq9FKoc9A2tw-0VlvUNVlZ0lXHeW9F4-PbryxE_0A',
      },
    })
      .then((response) => {
